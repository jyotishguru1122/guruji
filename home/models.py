...
class Festival(models.Model):
    ...
    january = models.TextField(blank=False)
    february = models.TextField(blank=False)
    march = models.TextField(blank=False)
    april = models.TextField(blank=False)
    may = models.TextField(blank=False)
    june = models.TextField(blank=False)
    july = models.TextField(blank=False)
    august = models.TextField(blank=False)
    september = models.TextField(blank=False)
    october = models.TextField(blank=False)
    november = models.TextField(blank=False)
    december = models.TextField(blank=False)
    def __str__(self):
        return self.january
